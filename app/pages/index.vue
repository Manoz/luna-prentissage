    ...
    <div class="relative">
      ...
      <nav class="container mx-auto px-6 py-8">
        <div class="flex items-center justify-between">
          <p class="text-3xl font-serif font-bold text-deep-teal">
        ...
        <section class="py-12 sm:py-20">
          <div class="container mx-auto px-6">
            <div class="max-w-4xl mx-auto text-center">
              ...
              >
                Une approche moderne pour apprendre et mémoriser les préfixes, suffixes et radicaux
        ...
        <section v-if="dataReady" class="container mx-auto px-6 py-20">
          <div class="max-w-6xl mx-auto">
            <div class="text-center mb-16">
              <h2 class="text-4xl font-serif font-bold text-deep-teal mb-4">
