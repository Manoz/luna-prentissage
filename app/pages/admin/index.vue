  ...
  <div class="min-h-screen bg-warmCream">
    ...
    <div class="relative">
        ...
        <div class="container mx-auto px-6 py-4">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-6">
              <NuxtLink to="/" class="text-2xl font-serif font-bold text-deepTeal">
                Luna<span class="text-terracotta">·</span>Prentissage
              </NuxtLink>
              <span class="text-sm text-deepTeal/60">Administration</span>
            </div>

            <button
              type="button"
              class="px-4 py-2 text-sm font-medium text-deepTeal/70 hover:text-terracotta transition-colors"
              @click="handleLogout"
            >
              Déconnexion
            </button>
      ...
      <div class="container mx-auto px-6 py-12">
        <!-- Welcome Section -->
        <div class="mb-12">
          <h1 class="text-4xl font-serif font-bold text-deepTeal mb-2">
            Tableau de bord
          </h1>
        ...
        <div v-if="!loading" class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center justify-between mb-4">
              <div class="w-12 h-12 rounded-full bg-deepTeal/10 flex items-center justify-center">
                <svg class="w-6 h-6 text-deepTeal" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="text-sm text-deepTeal/60">
              Catégories
            </div>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div class="flex items-center gap-4 mb-4">
              <div class="w-16 h-16 rounded-full bg-deepTeal/10 flex items-center justify-center group-hover:bg-deepTeal/20 transition-colors">
                <svg class="w-8 h-8 text-deepTeal" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
                </svg>
              </div>
              <div class="flex-1">
                <h3 class="text-xl font-serif font-bold text-deepTeal mb-1">
                  Gérer les catégories
                </h3>
                <p class="text-sm text-deepTeal/60">
                  Ajouter, modifier ou supprimer des catégories
                </p>
              </div>
              <svg class="w-6 h-6 text-deepTeal/40 group-hover:text-deepTeal group-hover:translate-x-1 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
