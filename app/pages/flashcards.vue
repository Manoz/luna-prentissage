        ...
        <div class="container mx-auto px-6 py-6">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              type="button"
              class="px-4 py-2 text-sm font-medium text-deep-teal/70 hover:text-deep-teal border border-deep-teal/20 rounded-full hover:bg-deep-teal/5 transition-all"
              @click="handleShuffle"
            >
        ...
        <div class="grid lg:grid-cols-[280px_1fr] gap-8">
          ...
          <main>
            ...
            <div v-else class="space-y-8">
              <!-- Progress -->
              <div class="flex items-center justify-between">
                <div class="text-sm text-deep-teal/70">
                  Carte <span class="font-semibold text-deep-teal">{{ currentIndex + 1 }}</span> sur
                  <span class="font-semibold text-deep-teal">{{ filteredTerms.length }}</span>
                </div>
